...
//---- Pull Trigger ----/
void AMP_HeroCharacter::PullTrigger()
{
	if (HasAuthority())
	{
...
bool AMP_HeroCharacter::ServerPullTrigger_Validate()
{
	// Optional: Add validation logic here (e.g., preventing cheating)
	return true;
}

void AMP_HeroCharacter::ServerPullTrigger_Implementation()
{
	MulticastPullTrigger();
}

void AMP_HeroCharacter::MulticastPullTrigger_Implementation()
{
	// Perform the shooting logic on all clients
	PerformPullTrigger();
}

void AMP_HeroCharacter::PerformPullTrigger()
{
	if (Gun != nullptr)
	{
		Gun->PullTrigger();
...
//---- Release Trigger ----/
void AMP_HeroCharacter::ReleaseTrigger()
{
	if (HasAuthority())
	{
...
bool AMP_HeroCharacter::ServerReleaseTrigger_Validate()
{
	// Optional: Add validation logic here (e.g., preventing cheating)
	return true;
}

void AMP_HeroCharacter::ServerReleaseTrigger_Implementation()
{
	MulticastReleaseTrigger();
}

void AMP_HeroCharacter::MulticastReleaseTrigger_Implementation()
{
	// Perform the shooting logic on all clients
	PerformReleaseTrigger();
}

void AMP_HeroCharacter::PerformReleaseTrigger()
{
	if (Gun != nullptr)
	{
		Gun->ReleaseTrigger();	
